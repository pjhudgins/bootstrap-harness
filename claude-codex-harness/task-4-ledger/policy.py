# Copied from ../task-3-ui/policy.py on 2026-09-24 (policy v2), unchanged. The harness's
# own dynamic tools (tools.Toolbox) are allowed in addition to REVIEWED_MODEL_TOOLS.
