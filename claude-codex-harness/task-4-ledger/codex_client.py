# Copied from ../task-3-ui/codex_client.py on 2026-09-24. Task 4 removed the JSONL
# Journal: AppServer now writes to any object with write(kind, **fields), which in task 4
# is ledger_log.LedgerJournal.
"""Codex App Server stdio client that records every message through a journal object.
