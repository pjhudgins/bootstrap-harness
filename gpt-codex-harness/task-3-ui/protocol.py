"""App Server transport adapted from the task-2 prototype; local to task 3."""
...
class Client:
    def __init__(self, journal, command, env, stop_event=None):
    ...
    def handle_request(self, message):
        params = message.get("params", {})
        if (message["method"] != "item/tool/call" or params.get("tool") not in TOOLS
        ...
        try:
            body = TOOLS[params["tool"]][1](params["arguments"])
            success = True
