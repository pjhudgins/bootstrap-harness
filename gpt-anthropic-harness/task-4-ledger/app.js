...
$('example').addEventListener('click', () => { $('prompt').value = 'Read the latest NIMOI onboarding. Describe your harness and available tools, then wait for my direction.'; availability(); $('prompt').focus(); });
